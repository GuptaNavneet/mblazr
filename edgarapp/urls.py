...
from .views import (
    ...
    AddReportHomePageView, AddCompanyReportsView, ErrorListenerView
)
...
urlpatterns = [
    ...
    path('addreport/', AddReportHomePageView, name='addreports'),
    path('filing/', SearchFilingView, name='companyFiling'),
    path('adding/', AddCompanyReportsView),
    path('emptybutton/', ErrorListenerView),
